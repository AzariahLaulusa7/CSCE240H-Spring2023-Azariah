...
void ReadFile() {
	...
	if (myfile.is_open()) {
		while (getline(myfile, line)) {
            ...
            // Check to see if there are only two integers
            if(input.length() > 2) {
                cout << "This file cannot be accepted. Each row must only have "
                    << "two positive integers! You have more than two integers!" << endl;
                return;
            } else if(input.length() < 2){
                cout << "This file cannot be accepted. Each row must only have "
                    << "two positive integers! You have less than two integers!" << endl;
                return;
            }

            // Create variables for number 1 and number 2
            char firstNumber = input.at(0);
            char secondNumber = input.at(1);
            ...
            if(choice == '1') {
                ...
                cout << "The result of dividing the first number " 
                    << firstNumber << " and the second number "
                    << secondNumber << " is...\n";
                cout << "\n" << output << " = " << total << "\n";
            } else if (choice == '2') {
	...
	if (in_myfile.is_open()) {
		if (out_myfile.is_open()) {
			while (getline(in_myfile, line)) {
                ...
                //Getting nums and putting all numbers in a string
                for(int i = 0; i < line.length(); i++) {
                    char num = line[i];
                    if(isdigit(num)) {
                        input += num;
                ...
                if(choice == '1') {
                    ...
                    out_myfile << "The result of adding the first number " 
                            << firstNumber << " and the second number "
                            << secondNumber << " is...\n";
                    ...
                    cout << "\t\t writing .. - " << output << " = " << total << "\n";
                    out_myfile << "The result of subtracting the first number " 
                            << firstNumber << " and the second number "
                            << secondNumber << " is...\n";
                    out_myfile << output << " = " << total << "\n";
                } else if (choice == '3') {
                    ...
                    cout << "\t\t writing .. - " << output << " = " << total << "\n";
                    out_myfile << "The result of multiplying the first number " 
                            << firstNumber << " and the second number "
                            << secondNumber << " is...\n";
                    out_myfile << output << " = " << total << "\n";
                }else if (choice == '4') {
                    ...
                    cout << "\t\t writing .. - " << output << " = " << total << "\n";
                    out_myfile << "The result of dividing the first number " 
                            << firstNumber << " and the second number "
                            << secondNumber << " is...\n";//?
                    out_myfile << output << " = " << total << "\n";
                } else {
...
int main()
{
    ...
    while(1) {
        ...
        if(input == '1') {
            ...
            cout << "\nYou did not enter a valid choice. Please choose between 1, 2, or 3!\n"
            << endl;
        }
    }
